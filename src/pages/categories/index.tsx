...
const CategoriesPage: NextPageWithLayout = () => {
  ...
  const { mutate: createCategory } = api.category.createCategory.useMutation({
    onSuccess: async () => {
      ...
      toast("Successfully created a new category"); //add alert success
  ...
  const { mutate: deleteCategoryById } =
    api.category.deleteCategoryById.useMutation({
      onSuccess: async () => {
        ...
        toast("Successfully deleted a category"); //add alert success
  ...
  const { mutate: editCategory } = api.category.editCategory.useMutation({
    onSuccess: async () => {
      ...
      toast("Successfully updated a category"); //add alert success
